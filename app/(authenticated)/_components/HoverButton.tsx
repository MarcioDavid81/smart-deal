...
const HoverButton: React.FC<HoverButtonProps> = ({
    ...
    return ( 
        <button
            className={`relative overflow-hidden px-4 py-2 font-medium border-2 border-secondary rounded-lg ${baseColor} text-gray-800 transition-all duration-300 ease-in-out ${className}`}
